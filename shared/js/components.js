            ...
            return `
                    ...
                    : `<span class="material-symbols-outlined text-6xl text-slate-300 dark:text-slate-700">redeem</span>`
                            ...
                            <div class="absolute top-3 right-3 flex flex-col gap-1.5 items-end">
                                ...
                                ` : ''}
                                ${hasPersonalityPrice ? `
                                    <div class="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md text-rose-600 font-black text-[11px] px-3 py-1.5 rounded-full shadow-lg border border-rose-100 dark:border-rose-900/20 flex items-center gap-1.5 justify-center transform group-hover:scale-105 transition-transform">
                                        <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Smilies/Red%20Heart.png" class="size-4 object-contain" />
                        ...
                        <div class="p-5 flex flex-col flex-1 bg-white dark:bg-[#1a140c]/40 relative z-10">
                            ...
                            <button
                                onclick="window.redeemPremiumItem && window.redeemPremiumItem('${item.id}')" 
